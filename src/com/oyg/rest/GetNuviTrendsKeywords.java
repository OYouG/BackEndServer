...
public class GetNuviTrendsKeywords {

    public List<NuviDailySummary> returningNuviTrendsKeywords()
    {
        // TODO Auto-generated method stub

        //Input file which needs to be parsed
        String fileToParse = "nuvi-export-trends_Keywords.csv";
        ...
        List<NuviDailySummary> nuviTrendsKeywordsData = new ArrayList<NuviDailySummary>();
        ...
        try
        {
            ...
            while( (line = fileReader.readLine()) != null)
            {
                ...
                nuviTrendsKeywordsData.add(day);
            }
            for(NuviDailySummary oneDaySummary: nuviTrendsKeywordsData)
            {
