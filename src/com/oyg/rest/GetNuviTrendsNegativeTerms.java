...
public class GetNuviTrendsNegativeTerms {

    public List<NuviDailySummary> returningNuviTrendsNegativeTerms()
    {
        // TODO Auto-generated method stub

        //Input file which needs to be parsed
        String fileToParse = "nuvi-export-trends_NegativeTerms.csv";
        ...
        List<NuviDailySummary> nuviTrendsNegativeTerms = new ArrayList<NuviDailySummary>();
        ...
        try
        {
            ...
            while( (line = fileReader.readLine()) != null)
            {
                ...
                nuviTrendsNegativeTerms.add(day);
            }
            for(NuviDailySummary oneDaySummary: nuviTrendsNegativeTerms)
            {
        ...
        return nuviTrendsNegativeTerms;
    }
