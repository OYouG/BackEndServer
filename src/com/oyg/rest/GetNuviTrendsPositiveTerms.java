...
public class GetNuviTrendsPositiveTerms {

    public List<NuviDailySummary> returningNuviTrendsPositiveTerms()
    {
        // TODO Auto-generated method stub

        //Input file which needs to be parsed
        String fileToParse = "nuvi-export-trends_PositiveTerms.csv";
        ...
        List<NuviDailySummary> nuviTrendsPositiveTerms = new ArrayList<NuviDailySummary>();
        ...
        try
        {
            ...
            while( (line = fileReader.readLine()) != null)
            {
                ...
                nuviTrendsPositiveTerms.add(day);
            }
            for(NuviDailySummary oneDaySummary: nuviTrendsPositiveTerms)
            {
        ...
        return nuviTrendsPositiveTerms;
    }
